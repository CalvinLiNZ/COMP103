...
public class Permutations {
    ...
    public void extendPermutation(Set<String> remainingItems, Stack<String> permutationSoFar, List<List<String>> allPermutations){
        ...
        List<String> it = new ArrayList<>(remainingItems);
        Iterator<String> itter = it.iterator();
        while(itter.hasNext()){
            String word = itter.next();
            remainingItems.remove(word);
            permutationSoFar.push(word);
